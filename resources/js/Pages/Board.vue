        ...
        <nav class="flex items-center">
          ...
          <Menu as="div" class="ml-3 relative z-10">
            <MenuButton class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 rounded-full">
              <img class="h-9 w-9 inline rounded-full" src="https://images.all-free-download.com/images/graphicwebp/raccoon_dog_profile_513888.webp" alt="">
            </MenuButton>
      ...
      <main class="flex-1 overflow-hidden">
        <div class="flex flex-col h-full">
          <div class="shrink-0 flex justify-between items-center p-4">
            ...
            <div>
              <button class="inline-flex text-white bg-white/10 hover:bg-white/20 px-3 font-medium text-sm text-white rounded-md">
          ...
          <div class="flex-1 overflow-x-auto">
            <div class="inline-flex h-full items-start px-4 pb-4 space-x-4">
              <div  v-for="item in Array.from({length:5})" class="w-72 bg-gray-200 max-h-full flex flex-col rounded-md">
                ...
                <div class="pb-3 pb-3 flex flex-col overflow-hidden">
                  <div class="px-3 flex-1 overflow-y-auto">
                    <ul class="space-y-3">
                      <li v-for="item in Array.from({length: 100})" class="group relative bg-white p-3 shadow rounded-md border-b border-gray-300 hover:bg-gray-50">
